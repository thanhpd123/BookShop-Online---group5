...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-8">
                    <a href="author" style="color: blue">AuthorMnG</a>
                            ...
                            <c:forEach items="${listBookManage}" var="i">
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="productdetailformarketing?BookID=${i.getBookID()}" class="btn btn-warning btn-sm">Edit</a>
                                    </td>
                                </tr>
                            </c:forEach>
                        </tbody>
                ...
                <div class="col-4">
                    ...
                    <form id="bookForm" action="BookManagementServlet" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select type="number" class="form-control" id="authorID" name="authorID" required>
