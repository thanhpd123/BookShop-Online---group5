...
<%@page import="entity.Orders, java.util.Enumeration, jakarta.servlet.http.HttpSession, java.util.Vector"%>
<!DOCTYPE html>
<html>
    <head>
                ...
                <div style="border-width:3px;border-style: solid">
                    ...
                    <section style="border-width:1px;border-color: gray;border-style: solid">
                        <div class="row">
                            ...
                            <div class="col-6">Sản phẩm: Tiền Không Từ Đâu</div>
                            <div class="col-6" style="text-align: right;color: red">Giá 100000</div>
                        </div>
                    </section>
