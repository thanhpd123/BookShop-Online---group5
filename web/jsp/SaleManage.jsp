        ...
        <div class="side-bar border-right" style="background-color: #E5D3B3">
            ...
            <div>
                ...
                <div class="border-top" style="width: 100%;">
                    <a href="Home?service=listAll" style="color: black;"><div class="pt-3 pb-3" style="padding-left: 12%; color: #664229"><i class="bi bi-house"></i> &nbsp;Trang Chủ</div></a>
                </div>
                <div class="border-top" style="width: 100%;">
                    <a href="SaleController?service=dashboard" style="color: black;"><div class="pt-3 pb-3" style="padding-left: 12%; color: #664229"><i class="bi bi-clipboard-data"></i> &nbsp;Thống Kê</div></a>
                </div>
                <div class="border-top border-bottom pt-3 pb-3">
                    <a href="SaleController?service=orderList" style="width: 100%; color: black"><div style="padding-left: 12%; color: #664229"><i class="bi bi-card-text"></i> &nbsp;Quản Lý Đơn Hàng</div></a>
                </div>
            </div>
        </div>
